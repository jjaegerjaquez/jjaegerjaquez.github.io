...
const INITIAL_CLASS = 'flex justify-between px-[15px] md:px-[35px] 12xl:px-[60px] py-3 12xl:py-5 transition-colors delay-75 ease-out font-light text-lg 12xl:text-4xl sticky top-0 z-50';
